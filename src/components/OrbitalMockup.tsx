...
export default function OrbitalMockup({ lang }: OrbitalMockupProps) {
  ...
  return (
    <div className="relative w-full py-10 flex flex-col items-center justify-center select-none" id="orbital-mockup-section">
      ...
      {/* Glow Rings representing CIRCLE orbit system */}
      <div className="absolute w-[360px] sm:w-[500px] h-[360px] sm:h-[500px] rounded-full border border-dashed border-[#1E1E24]/50 pointer-events-none flex items-center justify-center top-15 sm:top-25">
        ...
        >
          <div className="absolute inset-0" style={{ transform: 'rotate(0deg)' }}>
            <div 
              className={`absolute -top-1.5 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full transition-all duration-300 flex items-center justify-center ${
                switches.marketing 
        ...
        <div className="absolute w-[260px] sm:w-[350px] h-[260px] sm:h-[350px] rounded-full border border-[#6A00FF]/25">
          {/* Clean concentric aesthetic space */}
        </div>
      </div>

      {/* Main Grid Wrapper */}
      <div className="relative w-full max-w-lg mt-6 flex justify-center items-center px-4 sm:px-0">
        
        {/* PHYSICAL SMARTPHONE CONTAINER (With Gorgeous Cyan-Purple Gradient Border) */}
        <div className={`relative z-10 w-[270px] h-[550px] rounded-[44px] p-[5px] flex flex-col overflow-hidden translate-x-[45px] transition-all duration-500 ease-in-out ${
          isGlowOn 
          ...
          <div className="w-full h-full bg-[#0F0F14] rounded-[39px] p-3.5 flex flex-col relative overflow-hidden h-full">
            ...
            <div className="flex-1 flex flex-col justify-between py-1 text-left select-none h-full" id="stats-screen">
              ...
              <div className="flex-1 flex flex-col justify-start gap-4 pt-4 px-1">
                ...
                <div className="grid grid-cols-3 gap-x-3 gap-y-4 pt-1">
                  ...
                  {/* App Icon 2: Facebook */}
                  <a 
                    href="https://www.facebook.com/share/1BqVM75m1U/"
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={(e) => { e.stopPropagation(); }}
                    className="flex flex-col items-center gap-1 group cursor-pointer"
                  ...
                  {/* Placeholder App Icon 4: Future Slot */}
                  ...
                  {/* Placeholder App Icon 5: Future Slot */}
                  <div className="flex flex-col items-center gap-1 opacity-25">
                    <div className="w-11 h-11 rounded-xl border border-dashed border-gray-700 bg-white/2 flex items-center justify-center">
                      <span className="text-gray-500 font-bold text-[10px]">•</span>
                    </div>
                  ...
                  {/* Placeholder App Icon 6: Future Slot */}
                  <div className="flex flex-col items-center gap-1 opacity-25">
                    <div className="w-11 h-11 rounded-xl border border-dashed border-gray-700 bg-white/2 flex items-center justify-center">
                      <span className="text-gray-500 font-bold text-[10px]">•</span>
                    </div>
        ...
        {/* ORBIT CONTROLLER WIDGET - Bottom Left */}
        <div className="absolute -left-20 bottom-16 w-[184px] bg-[#0F0F14]/90 p-4 rounded-2xl border border-[#1E1E24] shadow-xl flex flex-col gap-3">
